...
* The MOD 3.0 file is [here](https://github.com/FAIR-IMPACT/MOD/blob/main/mod.ttl) (2024-02-29)
...
MOD1.4 is available on GitHub since 2018. MOD1.4 is considered stable (but surely improvable) and was used within AgroPortal to implement a new metadata model. See [TODO file](https://github.com/sifrproject/MOD-Ontology/blob/master/mod-v1.4_todos.txt) (and  history) for details.
...
**Clement Jonquet (INRAE and University of Montpellier)**  
<jonquet@lirmm.fr>  
(@jonquet) 
...
Other contributors, since MOD2, include: Yann Le Franc, Luiz Bonino.
